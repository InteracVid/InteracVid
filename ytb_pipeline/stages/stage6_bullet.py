...
Creates bullet-point summaries or annotations for reaction segments.
"""
...
def process_single_json(
    ...
    """Process a single JSON file for bullet creation.
...
def main():
    parser = argparse.ArgumentParser(description="Stage 6: Bullet creation with VLM")
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=args.max_workers, thread_name_prefix="BulletCreator") as executor:
        future_to_task = {
            executor.submit(
                process_single_json,
